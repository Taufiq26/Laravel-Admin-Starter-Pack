    ...
    $( document ).ready(function() {
		...
		$('#form').submit(function(event) {
			...
			if($('#postType').val() == 'create'){
				url = "<?php echo e(url('api/menu-access/create')); ?>";
			}else{
                url = "<?php echo e(url('api/menu-access/update')); ?>/"+_selectedID;
			}
			...
			.done(function(res) {
                ...
                autoReload('#dataTableMenus', '<?php echo e(url("api/menu-access")); ?>')
		...
		$('#dataTableMenus tbody').on('click','button[name="btn_edit"]',function(event){
			...
			$.ajax({
				url: "<?php echo e(url('api/menu-access')); ?>/"+_selectedID,
				type: 'GET',
				dataType: 'json',
			})
			.done(function(res) {
		...
		$('#dataTableMenus tbody').on('click', 'button[name="btn_hapus"]', function(event) {
            ...
            .then((willDelete) => {
                if (willDelete) {
                    $.ajax({
                        url: "<?php echo e(url('api/menu-access/delete')); ?>/"+_selectedID,
                        type: 'DELETE',
                        dataType: 'json',
                    })
                    .done(function(res) {
